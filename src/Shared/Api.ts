...
export type FetchArgsOptions = Omit<
  RequestInit,
  "method" | "redirect" | "body"
>;
...
export async function fetchJson<TData>(
  args: FetchArgs
): Promise<FetchResponse<TData, number> | FetchResponseOfError> {
  const errorResponse = (
    error: StandardError,
    status: number,
    args: FetchArgs
...
export function createRequest<TRequest>(
  ...
  const body =
    request !== undefined || !(request instanceof FormData)
...
>(
  ...
  return fetchJson<TResponse>(
    createRequest("POST", request, options, url, paramsObject)
  );
}
...
export function apiGet<TResponse extends FetchResponse<unknown, number>>(
  ...
  return fetchJson<TResponse>(
    createRequest("GET", undefined, options, url, paramsObject)
  );
}
...
>(
  ...
  return fetchJson<TResponse>(
    createRequest("PUT", request, options, url, paramsObject)
  );
}
...
export function apiDelete<TResponse extends FetchResponse<unknown, number>>(
  ...
  return fetchJson<TResponse>(
    createRequest("DELETE", undefined, options, url, paramsObject)
  );
}
...
>(
  ...
  return fetchJson<TResponse>(
    createRequest("PATCH", request, options, url, paramsObject)
  );
}
// INFRASTRUCTURE END
...
export const postApiComments = (
  requestContract: CreateCommentDTO,
  options?: FetchArgsOptions
): Promise<PostApiCommentsFetchResponse> => {
  const requestData = getApiRequestData<CreateCommentDTO>(
    requestContract,
    false
  );

  return apiPost(
    `${getApiUrl()}${postApiCommentsPath()}`,
    requestData,
    options
  ) as Promise<PostApiCommentsFetchResponse>;
};
...
export const getApiCommentsPostPostIdPath = (postId: number) =>
...
export const getApiCommentsPostPostId = (
  ...
  return apiGet(
    `${getApiUrl()}${getApiCommentsPostPostIdPath(postId)}`,
    options,
    {}
  ) as Promise<GetApiCommentsPostPostIdFetchResponse>;
};
...
export const getApiPostsId = (
  ...
  return apiGet(
    `${getApiUrl()}${getApiPostsIdPath(id)}`,
    options,
    {}
  ) as Promise<GetApiPostsIdFetchResponse>;
};
...
export const deleteApiPostsId = (
  ...
  return apiDelete(
    `${getApiUrl()}${deleteApiPostsIdPath(id)}`,
    options,
    {}
  ) as Promise<DeleteApiPostsIdFetchResponse>;
};
...
export const putApiPostsId = (
  ...
  return apiPut(
    `${getApiUrl()}${putApiPostsIdPath(id)}`,
    requestData,
    options
  ) as Promise<PutApiPostsIdFetchResponse>;
};
...
export const getApiUserProfile = (
  ...
  return apiGet(
    `${getApiUrl()}${getApiUserProfilePath()}`,
    options,
    {}
  ) as Promise<GetApiUserProfileFetchResponse>;
};
